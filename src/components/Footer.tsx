        ...
        <footer className="w-full bg-gray-100 text-gray-600 py-8">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-between">
                    ...
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2"><Link href="#about" className="hover:text-blue-600">About Us</Link></li>
                            <li className="mb-2"><Link href="#features" className="hover:text-blue-600">Features</Link></li>
                            <li className="mb-2"><Link href="#contact" className="hover:text-blue-600">Contact</Link></li>
                ...
                <div className="mt-8 border-t border-gray-200 pt-8 text-center text-sm">
                    <p>&copy; {new Date().getFullYear()} ExamCompass. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
